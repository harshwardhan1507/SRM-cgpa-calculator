    ...
    <>
          ...
          <div className="flex items-center gap-4 relative">
            ...
            {user ? (
              ...
              <Button
                ...
                className="bg-white hover:bg-neutral-200 text-black border border-[#1A1A1A] rounded-xl text-xs px-3.5 py-1.5 cursor-pointer flex items-center gap-2"
              >
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full bg-black border-t border-[#1A1A1A] z-45 flex justify-around py-3 px-4">
        ...
        >
          ...
          <span className="font-mono text-[8px] uppercase tracking-wider">Dashboard</span>
        </Link>
        <Link
          href="/sgpa"
          className={`flex flex-col items-center gap-1 transition-colors ${
            isActive('/sgpa') ? 'text-white' : 'text-[#71717A] hover:text-white'
          }`}
        >
      ...
      <Link href="/sgpa" className="md:hidden fixed bottom-20 right-5 z-40">
        <motion.button
