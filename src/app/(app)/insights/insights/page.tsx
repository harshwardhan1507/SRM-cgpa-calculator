...
export default function InsightsPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black text-[#FAFAFA] flex flex-col font-sans">
        <Navbar />
        <div className="flex-grow flex items-center justify-center font-mono text-xs text-muted-foreground animate-pulse">
  ...
  if (!semesters || semesters.length === 0) {
    return (
      <div className="min-h-screen bg-black text-[#FAFAFA] flex flex-col font-sans">
        <Navbar />
        <main className="flex-grow pt-[100px] pb-24 max-w-[1440px] mx-auto px-4 sm:px-6 w-full flex flex-col justify-center items-center text-center">
  ...
  return (
    <div className="min-h-screen bg-black text-[#FAFAFA] flex flex-col font-sans">
      ...
      <main className="flex-grow pt-[90px] pb-24 max-w-[1440px] mx-auto px-4 sm:px-6 w-full space-y-8">
